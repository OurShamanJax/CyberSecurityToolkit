...
const PAGES = [investigation, traffic, analyzer, credentials, wireless, exposure, vpn, atlas, exploits, payloads, report, settings];
...
const GROUPS=[
  ...
  {label:'Exploit',   ids:['analyzer','exploits','payloads']},
